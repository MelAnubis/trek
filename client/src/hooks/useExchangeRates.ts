 ...
 * display currency. Fetches exchangerate-api.com (no key) for the given base and
 * caches per base in memory + localStorage for 6 hours.
 * rates[X] = units of X per 1 base, so an amount in currency C converts to base
 * as `amount / rates[C]`.
 */
