import type { BookShapeId } from '../../types/book'

/**
 * Every shape Studio can draw, as a path on a 0..100 square. Ported from
 * liketrek/trek's client/src/components/Studio/shapes.ts (same AGPLv3
 * license) — no changes beyond the import path.
 *
