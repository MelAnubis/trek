const es: Record<string, string> = {
  ...
  'dashboard.suggestCover': 'Sugerir carátula',
  'dashboard.suggestCoverTitleRequired': 'Escribe antes un título para saber qué buscar',
  'dashboard.suggestCoverNoResults': 'No se encontraron sugerencias para este título',
  'dashboard.suggestCoverError': 'No se pudieron obtener sugerencias de carátula',
  ...
  'settings.mapDefaultHint': 'CartoDB ahora requiere una clave de API gratuita (ver abajo) — sin ella, o dejándolo vacío, el mapa muestra una marca de agua "API key required" en vez de las teselas.',
  'settings.mapTemplatePlaceholder': 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',
  'settings.mapOsmWarning': 'Los servidores de tiles de OpenStreetMap bloquean las solicitudes de apps y pueden mostrar errores "Access blocked". Usa CartoDB Light u otro proveedor en su lugar.',
  'settings.mapCartoKeyWarning': 'CartoDB requiere una clave de API gratuita desde agosto de 2026 (al instante, sin necesidad de cuenta, 5M de peticiones/mes gratis) — añade ?key=TU_CLAVE a la URL de arriba, desde',
  ...
  'settings.about.madeBy': 'por la comunidad Trek Wanderer.',
  ...
  'packing.print': 'Imprimir',
  'packing.printByCategory': 'Por categoría',
  'packing.printByBag': 'Por bolsa',
  ...
  // Impresión bajo demanda (Lulu Print API)
  'admin.printVendor.title': 'Impresión bajo demanda (Lulu)',
  'admin.printVendor.subtitle': 'Permite a los viajeros encargar una copia física impresa de su libro de Studio.',
  'admin.printVendor.clientKey': 'Client Key de Lulu',
  'admin.printVendor.clientSecret': 'Client Secret de Lulu',
  'admin.printVendor.sandbox': 'Modo sandbox',
  'admin.printVendor.sandboxHint': 'Usa la API de pruebas de Lulu en lugar de hacer pedidos reales.',
  'admin.printVendor.enabled': 'Activado',
  'admin.printVendor.enabledHint': 'Muestra la opción "Encargar copia impresa" en el panel de exportación de Studio una vez configuradas las credenciales.',
  'admin.printVendor.scaffoldNote': 'Esto es un andamiaje: los ajustes, presupuestos y creación de pedidos son llamadas reales a la API de Lulu, pero esta app aún no genera automáticamente un PDF listo para imprimir — los viajeros exportan su libro primero y luego enlazan ese archivo al pedir.',
  'admin.printVendor.testConnection': 'Probar conexión',
  ...
  'journey.route.km': 'km',
  'journey.route.m': 'm',
  'journey.route.maxElevation': 'máx {value} m',
  'journey.studio.title': 'Studio',
  'journey.studio.backToJourney': 'Volver a la travesía',
  'journey.studio.emptyTitle': 'Diseña tu libro de fotos',
  ...
  'journey.studio.pageSize': 'Tamaño de página',
  'journey.studio.pagePreset.square210': 'Cuadrado 210mm',
  'journey.studio.pagePreset.square300': 'Cuadrado 300mm',
  'journey.studio.pagePreset.a4Portrait': 'A4 vertical',
  'journey.studio.pagePreset.a4Landscape': 'A4 horizontal',
  'journey.studio.pagePreset.a5Landscape': 'A5 horizontal',
  'journey.studio.pagePreset.custom': 'Personalizado',
  'journey.studio.pageField.pageWidth': 'Ancho (mm)',
  'journey.studio.pageField.pageHeight': 'Alto (mm)',
  'journey.studio.pageField.bleed': 'Sangrado (mm)',
  ...
  'journey.studio.toFront': 'Traer al frente',
  'journey.studio.toBack': 'Enviar atrás',
  'journey.studio.rotateLeft': 'Rotar a la izquierda',
  'journey.studio.rotateRight': 'Rotar a la derecha',
  'journey.studio.lock': 'Bloquear',
  'journey.studio.unlock': 'Desbloquear',
  ...
  'journey.studio.pasteImageError': 'No se pudo pegar la imagen — es demasiado grande incluso comprimida',
  ...
  'journey.studio.moveSpreadUp': 'Mover página antes',
  'journey.studio.moveSpreadDown': 'Mover página después',
  'journey.studio.addText': 'Añadir texto',
  'journey.studio.addPhotoFrame': 'Añadir marco de foto',
  'journey.studio.addRect': 'Añadir rectángulo',
  'journey.studio.addEllipse': 'Añadir círculo',
  'journey.studio.moreShapes': 'Más formas…',
  ...
  'journey.studio.inspectorEmpty': 'Selecciona un elemento para editarlo',
  'journey.studio.document': 'Documento',
  'journey.studio.pageNumbers': 'Números de página',
  'journey.studio.pageDimensions': 'Página {w} × {h} mm',
  'journey.studio.bookView': 'Vista de libro',
  'journey.studio.format': 'Tamaño de página',
  'journey.studio.dropLabel': 'Suelta una foto aquí',
  'journey.studio.saveIdle': '',
  'journey.studio.saveSaving': 'Guardando…',
  'journey.studio.saveSaved': 'Guardado',
  'journey.studio.saveError': 'No se pudo guardar',
  'journey.studio.saveReadonly': 'Solo lectura',
  'journey.studio.saveConflictTitle': 'Otra persona guardó cambios',
  'journey.studio.saveConflictHint': 'Otro editor guardó este libro mientras trabajabas. Conserva tus cambios y guarda encima, o descártalos y toma los suyos.',
  ...
  'journey.studio.thisEntryPhotos': 'Esta entrada',
  'journey.studio.allPhotos': 'Todas las fotos',
  'journey.studio.noEntryPhotos': 'Aún no hay fotos vinculadas a esta entrada — suelta archivos aquí, o cambia a "Todas las fotos".',
  ...
  'journey.studio.autoLayoutBookBuilding': 'Generando mapas de ruta…',
  'journey.studio.autoLayoutBookConfirm': '¿Reemplazar todas las páginas con un diseño nuevo generado desde tu diario? Se puede deshacer.',
  'journey.studio.autoLayoutDone': 'Diseño aplicado',
  'journey.studio.export': 'Exportar',
  'journey.studio.exportOpen': 'Abrir vista de impresión',
  ...
  'journey.studio.exportFormat': 'Formato',
  'journey.studio.exportFormatPrint': 'Para imprenta',
  'journey.studio.exportFormatPrintHint': 'Con sangrado y opciones de corte, listo para una imprenta o para imprimir en casa',
  'journey.studio.exportFormatDigital': 'Libro digital',
  'journey.studio.exportFormatDigitalHint': 'PDF para leer en pantalla — sin sangrado ni marcas de corte, siempre a doble página',
  'journey.studio.exportLayout': 'Disposición',
  'journey.studio.exportPages': 'Páginas sueltas',
  'journey.studio.exportPagesHint': 'Una hoja por página — lo que pide una imprenta',
  'journey.studio.exportSpreads': 'Dobles páginas',
  'journey.studio.exportSpreadsHint': 'Dos páginas a la vez, como se abre el libro',
  'journey.studio.exportSpreadsDisabledHint': 'No disponible con una opción de impresión en casa — necesitan páginas sueltas',
  'journey.studio.exportHomeFinish': 'Impresión en casa (opcional)',
  'journey.studio.exportDuplex': 'Doble cara, encuadernado lateral',
  'journey.studio.exportDuplexHint': 'Orden de lectura normal — perfora, grapa o anilla por un lateral',
  'journey.studio.exportBooklet': 'Folleto plegado',
  'journey.studio.exportBookletHint': 'Reordena las páginas para que, al doblar el conjunto a doble cara, queden en orden',
  'journey.studio.exportHomeFinishNote': 'Activa la impresión a doble cara en el propio diálogo de tu impresora — una página web no puede hacerlo por ti. Imprime primero una prueba corta para comprobar que el borde de volteo de tu impresora coincide, antes de imprimir el libro entero.',
  ...
  'journey.studio.exportCoverSizeNote': 'La portada (sin lomo, sangrado en los 4 bordes) mide {width}×{height}mm, un poco más grande que las demás.',
  ...
  // Pedido de impresión bajo demanda (Lulu Print API)
  'journey.studio.print.orderButton': 'Encargar copia impresa',
  'journey.studio.print.title': 'Encargar copia impresa',
  'journey.studio.print.pdfUrlHint': 'Esta app aún no genera un PDF listo para imprimir automáticamente — exporta tu libro arriba, súbelo a algún sitio y pega el enlace abajo.',
  'journey.studio.print.pdfUrl': 'Enlace a tu PDF exportado',
  'journey.studio.print.quantity': 'Cantidad',
  'journey.studio.print.shippingLevel': 'Velocidad de envío',
  'journey.studio.print.contactEmail': 'Email de contacto',
  'journey.studio.print.shippingAddress': 'Dirección de envío',
  'journey.studio.print.addrName': 'Nombre completo',
  'journey.studio.print.addrStreet1': 'Dirección',
  'journey.studio.print.addrCity': 'Ciudad',
  'journey.studio.print.addrPostcode': 'Código postal',
  'journey.studio.print.addrCountry': 'Código de país (ej. ES)',
  'journey.studio.print.estimatedTotal': 'Total estimado',
  'journey.studio.print.yourOrders': 'Tus pedidos',
  'journey.studio.print.getEstimate': 'Ver presupuesto',
  'journey.studio.print.estimating': 'Calculando…',
  'journey.studio.print.placeOrder': 'Hacer pedido',
  'journey.studio.print.placingOrder': 'Enviando pedido…',
  'journey.studio.print.orderPlaced': '¡Pedido realizado!',
  'journey.studio.print.orderStatus': 'Estado: {status}',
  'journey.studio.print.estimateFailed': 'No se pudo calcular el presupuesto.',
  'journey.studio.print.orderFailed': 'No se pudo realizar el pedido.',
  ...
  'journey.frontpage.fromTrips': 'Desde tus viajes',
  'journey.frontpage.fromImmich': 'Importar desde Immich',
  'journey.frontpage.immichNote': 'Esto construye una ruta, paradas y lugares a partir de la ubicación GPS de las propias fotos del álbum — también crea un viaje para alojar la ruta importada, ya marcado como realizado.',
  'journey.frontpage.immichNamePlaceholder': 'Déjalo en blanco para usar el nombre del álbum',
  'journey.frontpage.selectAlbum': 'Selecciona un álbum de Immich',
  ...
  'journey.frontpage.maxGapHours': 'Nueva parada tras (horas)',
  'journey.frontpage.maxRadiusMeters': 'Nueva parada a más de (metros)',
  'journey.frontpage.tripType': 'Tipo de viaje',
  'journey.frontpage.tripTypeHint': 'Los viajes de bici/trekking muestran después una pestaña GPX en el Planificador, para revisar la ruta importada o adjuntar otro track más adelante.',
  'journey.frontpage.tripTypeGeneral': '🌍 General',
  'journey.frontpage.tripTypeCycling': '🚴 Bicicleta',
  'journey.frontpage.tripTypeTrekking': '🥾 Trekking',
  'journey.frontpage.attachGpx': 'Adjuntar track(s) GPX',
  'journey.frontpage.attachGpxHint': 'Opcional, pero recomendado: un archivo GPX es más denso y preciso que el GPS de las fotos, y puede cubrir días sin ninguna foto geolocalizada.',
  'journey.frontpage.selectGpxFiles': 'Seleccionar archivo(s) GPX',
  'journey.frontpage.removeGpxFile': 'Quitar archivo',
  ...
  'journey.public.noBook': 'Aún no se ha creado un libro para esta travesía.',
  ...
  'dashboard.filters.title': 'Filtros',
  'dashboard.filters.search': 'Buscar',
  'dashboard.filters.searchPlaceholder': 'Nombre del viaje o notas',
  'dashboard.filters.place': 'Lugar',
  'dashboard.filters.placePlaceholder': 'Ciudad, país…',
  'dashboard.filters.days': 'Número de días',
  'dashboard.filters.daysMin': 'Mín',
  'dashboard.filters.daysMax': 'Máx',
  'dashboard.filters.sortLabel': 'Ordenar por',
  'dashboard.filters.sort.date': 'Fecha de inicio',
  'dashboard.filters.sort.nameAsc': 'Nombre (A–Z)',
  'dashboard.filters.sort.nameDesc': 'Nombre (Z–A)',
  'dashboard.filters.sort.daysDesc': 'Más días',
  'dashboard.filters.sort.daysAsc': 'Menos días',
  'dashboard.filters.clear': 'Limpiar filtros',
  'dashboard.filters.noResults': 'Ningún viaje coincide con los filtros',
  'nav.profile': 'Perfil',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Bienvenido a Trek Wanderer',
  'system_notice.welcome_v1.body': 'Tu planificador personal de viajes. Organiza etapas, registra rutas y guarda los mejores lugares — todo en un solo sitio.',
  'system_notice.welcome_v1.cta_label': 'Crear mi primer viaje',
  'system_notice.welcome_v1.hero_alt': 'Interfaz de Trek Wanderer con mapa de viaje',
  'system_notice.welcome_v1.highlight_plan': 'Planifica etapas y rutas día a día',
  'system_notice.welcome_v1.highlight_share': 'Guarda lugares con fotos y notas',
  'system_notice.welcome_v1.highlight_offline': 'Importa rutas GPX para tus cicloviajes',
