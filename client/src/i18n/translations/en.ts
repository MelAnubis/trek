const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'dashboard.suggestCover': 'Suggest a cover',
  'dashboard.suggestCoverTitleRequired': 'Add a title first so we know what to search for',
  'dashboard.suggestCoverNoResults': 'No suggestions found for this title',
  'dashboard.suggestCoverError': 'Could not fetch cover suggestions',
  ...
  'settings.mapDefaultHint': 'CartoDB now requires a free API key (see below) — without one, or left empty, the map shows an "API key required" watermark instead of tiles.',
  'settings.mapTemplatePlaceholder': 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png',
  'settings.mapOsmWarning': "OpenStreetMap's tile servers block app requests and may show \"Access blocked\" errors. Use CartoDB Light or another provider instead.",
  'settings.mapCartoKeyWarning': 'CartoDB requires a free API key since August 2026 (instant, no account needed, 5M requests/month free) — add ?key=YOUR_KEY to the URL above, from',
  ...
  'settings.mapPoiPill': 'Explore places pill',
  'settings.mapPoiPillHint': 'Show the POI category pill on the planner map to explore nearby restaurants, cafes, sights, and more.',
  'poi.cat.restaurants': 'Restaurants',
  'poi.cat.cafes': 'Cafes',
  'poi.cat.bars': 'Bars',
  'poi.cat.hotels': 'Hotels',
  'poi.cat.sights': 'Sights',
  'poi.cat.museums': 'Museums',
  'poi.cat.nature': 'Nature',
  ...
  'settings.about.madeBy': 'by the Trek Wanderer community.',
  ...
  // Print-on-demand (Lulu Print API) admin settings
  'admin.printVendor.title': 'Print-on-Demand (Lulu)',
  'admin.printVendor.subtitle': 'Let travelers order a real, physically printed copy of their Studio book.',
  'admin.printVendor.clientKey': 'Lulu Client Key',
  'admin.printVendor.clientSecret': 'Lulu Client Secret',
  'admin.printVendor.sandbox': 'Sandbox mode',
  'admin.printVendor.sandboxHint': 'Use Lulu’s sandbox API and test credentials instead of placing real orders.',
  'admin.printVendor.enabled': 'Enabled',
  'admin.printVendor.enabledHint': 'Shows the "Order a printed copy" option in Studio’s export panel once credentials are set.',
  'admin.printVendor.scaffoldNote': 'This is a scaffold: settings, price estimates and order creation are real Lulu API calls, but this app does not yet render a print-ready PDF automatically — travelers export their book first, then link to that file when ordering.',
  'admin.printVendor.testConnection': 'Test connection',
  ...
  // Costs (Budget → Costs rework: Splitwise-style, multi-currency)
  'costs.you': 'You',
  'costs.youShort': 'Y',
  'costs.youLower': 'you',
  ...
  'costs.attachments': 'Receipt / attachments',
  'costs.addAttachment': 'Attach receipt or file',
  'costs.scanReceiptHint': "Add a photo of the receipt and we'll try to fill in the details automatically.",
  ...
  'journey.route.km': 'km',
  'journey.route.m': 'm',
  'journey.route.maxElevation': 'max {value} m',
  'journey.studio.title': 'Studio',
  'journey.studio.backToJourney': 'Back to journey',
  'journey.studio.emptyTitle': 'Design your photo book',
  ...
  'journey.studio.pageSize': 'Page size',
  'journey.studio.pagePreset.square210': 'Square 210mm',
  'journey.studio.pagePreset.square300': 'Square 300mm',
  'journey.studio.pagePreset.a4Portrait': 'A4 portrait',
  'journey.studio.pagePreset.a4Landscape': 'A4 landscape',
  'journey.studio.pagePreset.a5Landscape': 'A5 landscape',
  'journey.studio.pagePreset.custom': 'Custom',
  'journey.studio.pageField.pageWidth': 'Width (mm)',
  'journey.studio.pageField.pageHeight': 'Height (mm)',
  'journey.studio.pageField.bleed': 'Bleed (mm)',
  ...
  'journey.studio.pasteImageError': "Couldn't paste the image — it's too large even compressed",
  'journey.studio.addSpread': 'Add page',
  'journey.studio.duplicateSpread': 'Duplicate page',
  'journey.studio.removeSpread': 'Delete page',
  'journey.studio.moveSpreadUp': 'Move page earlier',
  'journey.studio.moveSpreadDown': 'Move page later',
  'journey.studio.addText': 'Add text',
  'journey.studio.addPhotoFrame': 'Add photo frame',
  'journey.studio.addRect': 'Add rectangle',
  'journey.studio.addEllipse': 'Add circle',
  'journey.studio.moreShapes': 'More shapes…',
  ...
  'journey.studio.inspectorEmpty': 'Select an element to edit it',
  'journey.studio.document': 'Document',
  'journey.studio.pageNumbers': 'Page numbers',
  'journey.studio.pageDimensions': 'Page {w} × {h} mm',
  'journey.studio.bookView': 'Book view',
  'journey.studio.format': 'Page size',
  'journey.studio.dropLabel': 'Drop a photo here',
  'journey.studio.saveIdle': '',
  'journey.studio.saveSaving': 'Saving…',
  'journey.studio.saveSaved': 'Saved',
  'journey.studio.saveError': 'Could not save',
  'journey.studio.saveReadonly': 'View only',
  'journey.studio.saveConflictTitle': 'Someone else saved changes',
  'journey.studio.saveConflictHint': 'Another editor saved this book while you were working. Keep your changes and save on top, or discard them and take theirs.',
  ...
  'journey.studio.thisEntryPhotos': 'This entry',
  'journey.studio.allPhotos': 'All photos',
  'journey.studio.noEntryPhotos': 'No photos linked to this entry yet — drop files here, or switch to "All photos".',
  ...
  'journey.studio.autoLayoutBookBuilding': 'Building route maps…',
  'journey.studio.autoLayoutBookConfirm': 'Replace every page with a fresh layout built from your journal? This can be undone.',
  'journey.studio.autoLayoutDone': 'Layout applied',
  'journey.studio.export': 'Export',
  'journey.studio.exportOpen': 'Open print view',
  ...
  'journey.studio.exportFormat': 'Format',
  'journey.studio.exportFormatPrint': 'For print',
  'journey.studio.exportFormatPrintHint': 'With bleed and trim options, ready for a print shop or a home printer',
  'journey.studio.exportFormatDigital': 'Digital book',
  'journey.studio.exportFormatDigitalHint': 'A PDF for reading on screen — no bleed or crop marks, always as spreads',
  'journey.studio.exportLayout': 'Layout',
  'journey.studio.exportPages': 'Single pages',
  'journey.studio.exportPagesHint': 'One leaf per sheet — what a print shop wants',
  'journey.studio.exportSpreads': 'Spreads',
  'journey.studio.exportSpreadsHint': 'Two pages at a time, the way the book opens',
  'journey.studio.exportSpreadsDisabledHint': 'Not available with a home-finishing option — those need single leaves',
  'journey.studio.exportHomeFinish': 'Home printing (optional)',
  'journey.studio.exportDuplex': 'Double-sided, side bound',
  'journey.studio.exportDuplexHint': 'Plain reading order — punch, staple or spiral-bind along one edge',
  'journey.studio.exportBooklet': 'Folded booklet',
  'journey.studio.exportBookletHint': 'Reorders pages so folding the double-sided stack once puts them back in order',
  'journey.studio.exportHomeFinishNote': 'Turn on two-sided (duplex) printing in your printer\'s own dialog — a web page can\'t set that for you. Print a short test first to confirm your printer\'s flip side matches, before running the whole book.',
  ...
  'journey.studio.exportCoverSizeNote': 'The cover (no gutter, bleed on all 4 edges) measures {width}×{height}mm, slightly larger than the rest.',
  ...
  // Print-on-demand ordering (Lulu Print API)
  'journey.studio.print.orderButton': 'Order a printed copy',
  'journey.studio.print.title': 'Order a printed copy',
  'journey.studio.print.pdfUrlHint': 'This app doesn’t generate a print-ready PDF automatically yet — export your book above, upload it somewhere, and paste a link to it below.',
  'journey.studio.print.pdfUrl': 'Link to your exported PDF',
  'journey.studio.print.quantity': 'Quantity',
  'journey.studio.print.shippingLevel': 'Shipping speed',
  'journey.studio.print.contactEmail': 'Contact email',
  'journey.studio.print.shippingAddress': 'Shipping address',
  'journey.studio.print.addrName': 'Full name',
  'journey.studio.print.addrStreet1': 'Street address',
  'journey.studio.print.addrCity': 'City',
  'journey.studio.print.addrPostcode': 'Postal code',
  'journey.studio.print.addrCountry': 'Country code (e.g. US)',
  'journey.studio.print.estimatedTotal': 'Estimated total',
  'journey.studio.print.yourOrders': 'Your orders',
  'journey.studio.print.getEstimate': 'Get price estimate',
  'journey.studio.print.estimating': 'Estimating…',
  'journey.studio.print.placeOrder': 'Place order',
  'journey.studio.print.placingOrder': 'Placing order…',
  'journey.studio.print.orderPlaced': 'Order placed!',
  'journey.studio.print.orderStatus': 'Status: {status}',
  'journey.studio.print.estimateFailed': 'Could not get a price estimate.',
  'journey.studio.print.orderFailed': 'Could not place the order.',
  ...
  'journey.frontpage.fromTrips': 'From your trips',
  'journey.frontpage.fromImmich': 'Import from Immich',
  'journey.frontpage.immichNote': 'This builds a route, stops and places from the album photos\' own GPS data — it also creates a trip to hold the imported route, already marked as done.',
  'journey.frontpage.immichNamePlaceholder': 'Leave blank to use the album\'s name',
  'journey.frontpage.selectAlbum': 'Select an Immich album',
  ...
  'journey.frontpage.tripType': 'Trip type',
  'journey.frontpage.tripTypeHint': 'Cycling/trekking trips show a GPX tab in Trip Planner afterward, so you can review the imported route or attach another track later.',
  'journey.frontpage.tripTypeGeneral': '🌍 General',
  'journey.frontpage.tripTypeCycling': '🚴 Cycling',
  ...
  'dashboard.filters.searchPlaceholder': 'Trip name or notes',
  'dashboard.filters.place': 'Place',
  'dashboard.filters.placePlaceholder': 'City, country…',
  'dashboard.filters.days': 'Number of days',
  'dashboard.filters.daysMin': 'Min',
  'dashboard.filters.daysMax': 'Max',
  'dashboard.filters.sortLabel': 'Sort by',
  'dashboard.filters.sort.date': 'Start date',
  'dashboard.filters.sort.nameAsc': 'Name (A–Z)',
  'dashboard.filters.sort.nameDesc': 'Name (Z–A)',
  'dashboard.filters.sort.daysDesc': 'Most days',
  'dashboard.filters.sort.daysAsc': 'Fewest days',
  'dashboard.filters.clear': 'Clear filters',
  'dashboard.filters.noResults': 'No trips match your filters',
