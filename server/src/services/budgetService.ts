...
export function createBudgetItem(
  ...
  // total_price is derived from explicit payers when given; otherwise the caller value.
...
// ---------------------------------------------------------------------------
// Settlement calculation (greedy debt matching, multi-currency aware)
// ---------------------------------------------------------------------------
